...
#define CDTLogWarn(context, frmt, ...)                                                     \
    LOG_MAYBE(CDTLogAsync, CDTLoggingLevels[context - CDTSTART_CONTEXT], DDLogFlagWarning, \
              context, nil, __PRETTY_FUNCTION__, frmt, ##__VA_ARGS__)
#define CDTLogInfo(context, frmt, ...)                                                           \
    LOG_MAYBE(CDTLogAsync, CDTLoggingLevels[context - CDTSTART_CONTEXT], DDLogFlagInfo, context, \
              nil, __PRETTY_FUNCTION__, frmt, ##__VA_ARGS__)
#define CDTLogDebug(context, frmt, ...)                                                           \
    LOG_MAYBE(CDTLogAsync, CDTLoggingLevels[context - CDTSTART_CONTEXT], DDLogFlagDebug, context, \
              nil, __PRETTY_FUNCTION__, frmt, ##__VA_ARGS__)
#define CDTLogVerbose(context, frmt, ...)                                                  \
    LOG_MAYBE(CDTLogAsync, CDTLoggingLevels[context - CDTSTART_CONTEXT], DDLogFlagVerbose, \
              context, nil, __PRETTY_FUNCTION__, frmt, ##__VA_ARGS__)
