...
/// Return an autoreleased NSData w/ the result of gzipping the bytes using |level| compression
/// level.
//
...
/// Return an autoreleased NSData w/ the result of gzipping the payload of |data| using |level|
/// compression level.
...
/// Return an autoreleased NSData w/ the result of deflating the bytes using |level| compression
/// level.
//
// |level| can be 1-9, any other values will be clipped to that range.
...
/// Return an autoreleased NSData w/ the result of deflating the payload of |data| using |level|
/// compression level.
