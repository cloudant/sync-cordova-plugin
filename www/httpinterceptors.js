 ...
 * @classdesc The {@link HttpInterceptorContext} prototype is an interface for
 * manipulating an HTTP connection when the request or response has been
 * intercepted.
 ...
 * @property {Boolean} replayRequest - A flag that indicates whether or not to
 * replay the request. This should be set in a response interceptor.
 * @property {Function} done - The function to call when done modifying the
 * {@link HttpInterceptorContext}
 */
